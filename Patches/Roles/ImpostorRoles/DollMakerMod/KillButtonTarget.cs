...
namespace TownOfUs.ImpostorRoles.DollMakerMod
{
    ...
    public class KillButtonTarget
    {
        ...
        {
            if (!PlayerControl.LocalPlayer.Is(RoleEnum.DollMaker)) return true;
            return __instance == DestroyableSingleton<HudManager>.Instance.KillButton;
        }

        public static void SetTarget(KillButtonManager __instance, DeadBody target, DollMaker role)
        {
