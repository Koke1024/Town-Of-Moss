    ...
    public static class RpcHandling
    {
                ...
                switch ((CustomRPC) callId)
                {
                    case CustomRPC.SetRole:
                        ...
                        switch ((RoleEnum)readByte1) {
                            ...
                            case RoleEnum.Sniffer: new Sniffer(Utils.PlayerById(readByte)); break;
                            default:
        ...
        public static class RpcSetInfected
        {
            public static void Prefix([HarmonyArgument(0)] ref Il2CppReferenceArray<GameData.PlayerInfo> infected)
            {
                ...
                if (Check(CustomGameOptions.SnifferOn))
                    CrewmateRoles.Add((typeof(Sniffer), (byte)RoleEnum.Sniffer, CustomGameOptions.SnifferOn));
                #endregion
