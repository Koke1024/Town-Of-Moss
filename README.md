...
当MODは [Town of Us](https://github.com/polusgg/Town-Of-Us) を個人的に改変した、[Among Us](https://www.innersloth.com/games/among-us/) の非公式MODです。\
...
生存している自分以外のすべてのクルーに油を塗った後にIgniteすると勝利します。
油を塗るためには3秒間接触している必要があります。
