...
|---|----------|-------------|-----------------|
| 2021.11.9.5s | 21-02-09 | v1.4.1 | [Download](https://github.com/Koke1024/Town-Of-Moss/releases/latest) |
...
### 導入方法
新規導入の場合は、Moss～.zipのファイルをMODの導入されていないv2021.11.9.5のAmong Usディレクトリに展開してください。\
Town of Moss以外のMODの導入されたディレクトリに展開すると正常に動作しません。\
MODの更新の場合に必要なのはTownOfMoss.dllのみなので、DLL～.zipをAmong Usディレクトリに展開してください。
