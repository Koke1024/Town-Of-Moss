...
* Town of Mossの仕様
        <ul>
            <li>会議を行ってもインポスターのキルクールダウンがリセットされない</li>
            <li>残り一人になったインポスターがスナイパー能力（会議中に役職を当てればキルできる）を得る</li>
            ...
            <li>Polus、AirShipの緊急サボタージュの制限時間を変更可能</li>
            <li>Admin、SecurityCameraの制限時間を設定可能</li>
            <li>Polusのバイタルの位置を変更可能</li>
        </ul>


## 最新リリース
Among Us最新版の12.15s版には対応していません。何らかの方法で旧バージョン（11.9.5s）のデータを用意していただく必要があります。\
Moss***.zip：バニラのAmong Usに新規にTown of Moss MODを追加する場合に利用\
DLL***.zip：Town of Moss導入済みのディレクトリに更新を行う場合に利用

| Among Us - Version| Date | Mod Version | Link |
|---|----------|-------------|-----------------|
| 2021.11.9.5s | 2022-03-21 | v1.4.7 | [Download](https://github.com/Koke1024/Town-Of-Moss/releases/latest) |
...
<details>
    ...
    <details>
        ...
        <ul>
            <li>BodyGuardの矢印が会議明けに残っている不具合を修正</li>
        </ul>
    </details>
    <details>
...
### 導入方法
#### 新規導入の場合
Moss～.zipのファイルをMODの導入されていないv2021.11.9.5のAmong Usディレクトリに展開してください。\
Town of Moss以外のMODの導入されたディレクトリに展開すると正常に動作しません。
#### 導入済みのディレクトリで新バージョンのMODを更新する場合
更新の場合に必要なのはTownOfMoss.dllのみなので、DLL～.zipをAmong Usディレクトリに展開してください。
...
| Name | Description | Type | Default |
|----------|:-------------:|:------:|:------:|
| Report Degradation Duration | 容疑者候補の数が増える間隔 | Time | 5s |
...
死んだクルーを次の会議が終わるまで一時的に生存させます。蘇生されたクルーは会議終了と同時に死亡します。
...
| Name | Description | Type | Default |
|----------|:-------------:|:------:|:------:|
| Blackout Duration | 停電の継続時間 | Time | 10s |
| Crack Duration | 停電以外のハック効果の継続時間 | Time | 10s |
...
| Name | Description | Type | Default |
|----------|:-------------:|:------:|:------:|
| Madmate Can Vent | ベント利用できる | Toggle | Off
